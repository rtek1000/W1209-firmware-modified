'
' W1209 remote test (serial port 9600 bauds)
' 
...
Public Partial Class MainForm	
    ...
    Dim relayModeStr() As String = {"C1", "C2", "C3", _
    	"H1", "H2", "H3", _
    	"A1", "A2"}
    ...
    Dim params_default() As String = {"C1", "20.0", "110.0", _
    	"-50.0", "0.0", "0.0", "OFF", "OFF", "OFF", "28.0"}
...
'		PlotChart()
		...
		For i As Double = 15 To 0.1 Step -0.1
			cbx_P1.Items.Add(i.ToString("#0.0"))
		Next
				
		For i As Double = 110 To -49.9 Step -0.1
			cbx_P2.Items.Add(i.ToString("#0.0"))
		Next
				
		For i As Double = 109.9 To -50.0 Step -0.1
			cbx_P3.Items.Add(i.ToString("#0.0"))
		Next
				
		For i As Double = 7.0 To -7.0 Step -0.1
			cbx_P4.Items.Add(i.ToString("#0.0"))
		Next
				
		For i As Double = 10 To 0 Step -1
...
'    End Sub
    ...
    Private Sub serial_DataReceived(ByVal sender As Object, ByVal e As System.IO.Ports.SerialDataReceivedEventArgs) Handles serial.DataReceived
    	...
    	If strReceived.Length = 11 Then    		
    		...
    		Dim value1 As Double = Val(strReceived.Substring(2, 5))
    		
    		Dim str1 As String = value1.ToString("##0.0")
    		
    		If int1 >= 0 Then
	    		Dim index As Integer = buffer(1) - 65
	    			    		
	    		If index >= 0 And index <= 8 Then
	    			received_str1(index) = str1
	    		Else If index = 19 Then ' T
	    			received_str1(10) = str1
	    		End If
    		End If
	...
	Sub Timer1Tick(sender As Object, e As EventArgs)
		...
		textboxes(0).Text = relayModeStr(int1)
...
'				End If
			...
			If Cbx_P1.Text <> "" Then
				...
				For i As Double = 15 To 0.1 Step -0.1
					If Cbx_P1.Text = i.ToString("#0.0") Then
						str1 = str1.Remove(3, 4).Insert(3, i.ToString("00.0"))
						str1 = str1.Replace(",", ".")
					End If
				Next
...
'				End If
			...
			If Cbx_P2.Text <> "" Then
				...
				For i As Double = 110 To -49.9 Step -0.1
					If Cbx_P2.Text = i.ToString("#0.0") Then
						If i >= 0 Then
							str1 = str1.Remove(2, 5).Insert(2, i.ToString("000.0"))
						Else
							str1 = str1.Remove(2, 5).Insert(2, i.ToString("#00.0"))
						End If
...
'				End If
			...
			If Cbx_P3.Text <> "" Then
				...
				For i As Double = 109.9 To -50.0 Step -0.1
					If Cbx_P3.Text = i.ToString("#0.0") Then
						If i >= 0 Then
							str1 = str1.Remove(2, 5).Insert(2, i.ToString("000.0"))
						Else
							str1 = str1.Remove(2, 5).Insert(2, i.ToString("#00.0"))
...
'				End If
			...
			If Cbx_P4.Text <> "" Then
				...
				For i As Double = 7.0 To -7.0 Step -0.1
					If Cbx_P4.Text = i.ToString("#0.0") Then
						If i >= 0 Then
							str1 = str1.Remove(2, 5).Insert(2, i.ToString("000.0"))
						Else
							str1 = str1.Remove(2, 5).Insert(2, i.ToString("#00.0"))
			...
			If Cbx_P5.Text <> "" Then
				...
				For i As Double = 10 To 0 Step -1
					If Cbx_P5.Text = i.ToString("#0") Then
						str1 = str1.Remove(3, 2).Insert(3, i.ToString("00"))
						str1 = str1.Replace(",", ".")
...
'				End If
			...
			If Cbx_P6.Text <> "" Then
				...
				If Cbx_P6.Text = "ON" Then
					str1 = str1.Remove(6, 1).Insert(6, "1")
				Else If Cbx_P6.Text = "OFF" Then
...
'		cbx_P8.Items.Add("OFF")	
	...
	Sub Btn_SaveClick(sender As Object, e As EventArgs)
        ...
        saveFileDialog1.FileName = "W1209_setup.dat"
