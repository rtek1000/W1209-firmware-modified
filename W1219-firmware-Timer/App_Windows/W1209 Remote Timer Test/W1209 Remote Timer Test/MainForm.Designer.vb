...
Partial Class MainForm
	...
	Private Sub InitializeComponent()
		...
		Me.cbx_P1.Tag = "1"
		Me.toolTip1.SetToolTip(Me.cbx_P1, "P1: Time 1 (minutes)")
		...
		Me.toolTip1.SetToolTip(Me.cbx_serial_port, "Auto detect serial ports at initialization")
		AddHandler Me.cbx_serial_port.SelectedIndexChanged, AddressOf Me.Cbx_serial_portSelectedIndexChanged
		...
		Me.toolTip1.SetToolTip(Me.btn_connect, "Connect/Disconnect to device")
		...
		Me.toolTip1.SetToolTip(Me.tbx_received, "Received byte count / seconds")
		...
		Me.cbx_P2.Tag = "2"
		Me.toolTip1.SetToolTip(Me.cbx_P2, "P2: Time 1 (seconds)")
		...
		Me.cbx_P3.Tag = "3"
		Me.toolTip1.SetToolTip(Me.cbx_P3, "P3: Time 1 (milliseconds)")
		...
		Me.label5.Text = "P3: T1 milliseconds"
		'
		'cbx_P4
		'
		...
		Me.cbx_P4.Tag = "4"
		Me.toolTip1.SetToolTip(Me.cbx_P4, "P4: Time 2 (minutes)")
		...
		Me.cbx_P5.Tag = "5"
		Me.toolTip1.SetToolTip(Me.cbx_P5, "P5: Time 2 (seconds)")
		...
		Me.cbx_P6.Tag = "6"
		Me.toolTip1.SetToolTip(Me.cbx_P6, "P6: Time 2 (milliseconds)")
		...
		Me.label8.Text = "P6: T2 milliseconds"
		'
		'cbx_P7
		'
		...
		Me.label10.Text = "P7: Factory lock"
		'
		'cbx_P8
		'
		...
		Me.label16.Text = "Relay cycle count:"
		'
		'btn_Set
		'
		...
		Me.toolTip1.SetToolTip(Me.btn_Set, "Sends commands")
		...
		Me.toolTip1.SetToolTip(Me.btn_Clear, "Clear local Adjust configs")
		...
		Me.toolTip1.SetToolTip(Me.btn_Exit, "Exit App")
		...
		Me.toolTip1.SetToolTip(Me.textBox11, "Commands list received")
		...
		'btn_restart
		'
		Me.btn_restart.Location = New System.Drawing.Point(391, 142)
		Me.btn_restart.Name = "btn_restart"
		Me.btn_restart.Size = New System.Drawing.Size(106, 45)
		Me.btn_restart.TabIndex = 53
		Me.btn_restart.Text = "Restart"
		Me.toolTip1.SetToolTip(Me.btn_restart, "Sends a command like Restart button")
		Me.btn_restart.UseVisualStyleBackColor = true
		AddHandler Me.btn_restart.Click, AddressOf Me.Btn_restartClick
		'
		'btn_LogClear
		'
		...
		Me.toolTip1.SetToolTip(Me.btn_Load, "Load Adjusts values from file to local Adjusts")
		...
		Me.toolTip1.SetToolTip(Me.btn_Save, "Save device Adjust to file")
		...
		Me.toolTip1.SetToolTip(Me.btn_Default, "Load local Adjusts config")
		...
		Me.Text = "W1209_Remote_Timer_Test"
		AddHandler FormClosing, AddressOf Me.MainFormFormClosing
		AddHandler Load, AddressOf Me.MainFormLoad
		Me.ResumeLayout(false)
		Me.PerformLayout
	End Sub
	Private btn_restart As System.Windows.Forms.Button
