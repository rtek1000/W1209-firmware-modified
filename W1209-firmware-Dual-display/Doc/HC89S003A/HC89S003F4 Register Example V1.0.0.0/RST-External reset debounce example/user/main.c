...
/***************************************************************************************
  * @Function	After the system is powered on, P00 flips 5 times. If the reset button is pressed, 
...
/**********************************External reset initialization**************************************/    
	//External reset debounce time calculation = RSTDBC[7:0] * 8Tcpu + 2Tcpu
	//					   = 255 * 8 * 0.0625us + 2 * 0.0625us
	//					   = 127.625us
    
	RSTDBC = 0xFF;					              //Set the external reset debounce time to 127.625us
