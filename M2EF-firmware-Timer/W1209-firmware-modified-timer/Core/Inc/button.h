...
// Port C control input from button 1.
#define BUTTONS_PORT1    PC_IDR

// PC.4
#define BUTTON1_BIT      0x10
#define BUTTON1_POS      4

// Port B control input from button 2.
#define BUTTONS_PORT2    PB_IDR

// PB.5
#define BUTTON2_BIT      0x20
#define BUTTON2_POS      5

// Port A control input from button 3.
#define BUTTONS_PORT3    PA_IDR

// PA.2
#define BUTTON3_BIT      0x04
#define BUTTON3_POS      2

// Port B control input from button 4.
#define BUTTONS_PORT4    PB_IDR

// PB.4
#define BUTTON4_BIT      0x10
#define BUTTON4_POS      4

// Port C control input from button 5.
#define BUTTONS_PORT5    PC_IDR

// PC.3
#define BUTTON5_BIT      0x04
#define BUTTON5_POS      3

// Port D control input from button 6.
#define BUTTONS_PORT6    PD_IDR

// PD.5
#define BUTTON6_BIT      0x20
#define BUTTON6_POS      5
