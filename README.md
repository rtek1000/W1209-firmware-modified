...
- The generic schematic diagram shows the value of 20K ohms for R2, if your board has a different value for R2 or for the sensor, it may be necessary to change the table rawADC[]:
